...
public partial class Admin_TestImageQuestions : System.Web.UI.Page
{
    string usercode = "";
    int userid = 0;
    ...
    private void GoToPreviousPage()
    {
        ...
        Session["SubCtrl"] = "TestFillBalnksQues.aspx";
        Response.Redirect("TestFillBalnksQues.aspx");
    }
    ...
    private void FillQuestion()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = slno - 1; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                string Answer = "****";
                Session["CurrentControlCtrl"] = "TestImageQuestions.aspx";// bip 08012010
                Session["ValueExists"] = "True";
    ...
    private void GoToNextPage()
    {
        ...
        Session["SubCtrl"] = "TestPhotoTypeQuestions.aspx";// "WordTypeMemmoryQuestions.ascx";
        //Session["SubCtrl"] = "VideoQuestions.ascx";
        Response.Redirect("TestPhotoTypeQuestions.aspx");
    }
    ...
    private void SaveAnswer()
    {
        ...
        if (lblQuesID2.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid2, usercode, tcellQues2.InnerHtml, answer, userid, testId, testsectionid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID3.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid3, usercode, tcellQues3.InnerHtml, answer, userid, testId, testsectionid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID4.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid4, usercode, tcellQues4.InnerHtml, answer, userid, testId, testsectionid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID5.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid5, usercode, tcellQues5.InnerHtml, answer, userid, testId, testsectionid, quescategory);
        }
        answer = "";
