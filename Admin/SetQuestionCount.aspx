<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CJAdminMaster.master" ValidateRequest="false"  AutoEventWireup="true" CodeFile="SetQuestionCount.aspx.cs" Inherits="Admin_SetQuestionCount" %>
        ...
        <tr>
            <td colspan="2">
                <asp:Panel ID="Panel2" runat="server" HorizontalAlign="Left" Width="900px">
                    <asp:GridView ID="gvwQuestionCount" runat="server" AutoGenerateColumns="False" ForeColor="#800000" 
            ...
            <td colspan="2">
                <div align="center">
                    <asp:LinqDataSource ID="LinqQuestionCount" runat="server" 
                        ContextTypeName="CJDataClassesDataContext" OrderBy="ID" 
