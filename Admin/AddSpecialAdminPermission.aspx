<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CJAdminMaster.master" AutoEventWireup="true" CodeFile="AddSpecialAdminPermission.aspx.cs" Inherits="Admin_AddSpecialAdminPermission" %>
                                        ...
                                        <td>
                                            <div>
                                                <asp:GridView ID="gvwUserPermissions" runat="server" 
                                                    ...
                                                    DataSourceID="LinqUserPermissions" GridLines="Horizontal" EnableModelValidation="True">
                                                    <Columns>
                                                        <asp:TemplateField>
