...
public partial class Admin_SetQuestionCount : System.Web.UI.Page
{
    ...
    private void FillTestList()
    {
        ...
        int testIndex = 0; int adminaccess = 1;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (validateSelection() == true)
            if (ValidateCount() == true)
            {
                ...
                cjDataclass.AddQuestionCount(id, sectionid, sectionname, subsection1name, subsection2name, objcount, fillblanksCount, ratingquestioncount, imagequescount, videoquescount, audioquescount, userid, organizationid, testId, testsectionid, wordtypememQuestioncount, imagetypememQuestioncount, photoquescount);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (Session["countid"] != null)
        {
            ...
            cjDataclass.DeleteQuestionCount(id);
