...
public partial class Admin_TestWordTypeMemmoryQuestions : System.Web.UI.Page
{
    ...
    private void GoToNextPage()
    {
        ...
        Session["SubCtrl"] = "TestImageTypeMemmoryQuestions.aspx";
        Response.Redirect("TestImageTypeMemmoryQuestions.aspx");
    }
    ...
    private void GoToPreviousPage()
    {
        ...
        Session["SubCtrl"] = "TestPhotoTypeQuestions.aspx";// "ImageQuestions.ascx";
    ...
    private void FillMemWordQuestionInstructions(int dispalytype)
    {
        ...
        var InstructionDetails = from instructiondet in cjDataclass.InstructionByDisplayTypes
    ...
    private void SaveAnswer()
    {
        ...
        if (lblQuesID1.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid1, "", tcellQues1.InnerHtml, answer, userid, testId, testsectionid, quescategory);
        }
                ...
                if (Session["displaystatus"].ToString() == "True")
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = slno - 1; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            string Answer = "";
                            Session["CurrentControlCtrl"] = "TestWordTypeMemmoryQuestions.aspx";// bip 08012010
    ...
    private DataSet GetQuestionList(int testsectionid)
    {
        ...
        {
            Session["questionColl_memWords"] = null; dsQuestionList = null;
