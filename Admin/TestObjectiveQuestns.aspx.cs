...
public partial class Admin_TestObjectiveQuestns : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (cc == 1)
        {
            ...
            if (Session["curtestid"] != null)
            {
                ...
                SetTestSectionTimeDetails();
                SetTestSectionVariableTimeDetails();
            }
        }
    }
    private void SetTestSectionTimeDetails()// 24-02-2010 bip
    {
        ...
        {
            var GetTestTimeDuration = from testtimedet in cjDataclass.TimerDetails
        ...
        // 24-02-2010 bip
        var GetTotalTestTimeRemains = from testtimedet in cjDataclass.TimerDetails
                                      where testtimedet.TestId == testId && testtimedet.TestSectionId == testsectionid && testtimedet.TestVariableId > 0
                                      select testtimedet;
    ...
    private void SaveAnswer()
    {
        ...
        if (lblQuesID1.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid1, usercode, tcellQues1.InnerHtml, answer, userid, testId, testsecid, quescategory);
        ...
        if (lblQuesID2.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid2, usercode, tcellQues2.InnerHtml, answer, userid, testId, testsecid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID3.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid3, usercode, tcellQues3.InnerHtml, answer, userid, testId, testsecid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID4.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid4, usercode, tcellQues4.InnerHtml, answer, userid, testId, testsecid, quescategory);
        }
        answer = "";
        ...
        if (lblQuesID5.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid5, usercode, tcellQues5.InnerHtml, answer, userid, testId, testsecid, quescategory);
        }
    }
    ...
    private int GetTestSectionId()
    {
        ...
        try
        {
            ...
            {
                string condition = "";
                var getTestSectiondetails = from testsecdet in cjDataclass.UserTestSectionDetails
            ...
            else
            {
                ...
                if (GridView1.Rows.Count > 0)
                {
                    for (int v = 0; v < GridView1.Rows.Count; v++)
                    {
                        ...
                        {
                            var getSecondVariableName = from variabledet in cjDataclass.SectionDetails
                            ...
                            if (firstvariableid > 0)
                            {
                                if (secondvariablename != "")
                                {
                                    var getSecondVariableName1 = from variabledet in cjDataclass.SectionDetails
    ...
    {
        Session["curTestSectionVariableId_timer"] = null;
        Session["TestSectionVariableTimeDuration"] = null;
        ...
        if (index == 0)
        {
            Session["TestSectionTimeDuration"] = null;
            Session["VariableIdIndexNo"] = null;
            Session["dsTestVariableIds"] = null;
            Session["VariableIdIndexNo_timer"] = null;
    ...
    private void GoToPreviousPage()
    {
        ...
        Response.Redirect("TestIntroduction.aspx");
    }
    ...
    private void FillPreviousDetails()
    {
        ...
        {
            pagecount--;
            Session["pagecount"] = pagecount; SetCurrentPageCount();
            FillQuestion();
        }
        else
        {
    ...
    private void SetNextSectionVariableDetails_Timer()
    {
    ...
    private void DeleteTempValuesFromDB()
    {
        cjDataclass.DeleteUserTest_TempValues(userid, 0, 0);
    }
    ...
    private void ReloadCurrentControl()
    {
        ...
        if (Session["VariableIdIndexNo"] != null)
        {
            ...
            variableIdPageNo = variableIdPageNo - 1;
            Session["VariableIdIndexNo"] = variableIdPageNo.ToString();
            Session["VariableIdIndexNo_timer"] = variableIdPageNo.ToString();
