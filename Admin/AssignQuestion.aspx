<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CJAdminMaster.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="AssignQuestion.aspx.cs" Inherits="Admin_AssignQuestion" %>
                ...
                <table style="height: 350px;">
                    <tr>
                        <td colspan="2" 
                            valign="top">
                            <h3>
                            Assign Evaluation Test Questions</h3>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td colspan="7">
                                        <asp:Panel ID="Panel5" runat="server" ScrollBars="Auto" Width="750px">
                                            <asp:GridView ID="gvwVariableBands" runat="server" 
                                                AutoGenerateColumns="False"  ForeColor="#800000"
