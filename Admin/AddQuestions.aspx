...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="height: 350px;">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:Panel ID="Panel1" runat="server" Height="300px" HorizontalAlign="Left" ForeColor="#800000"
                    ScrollBars="Auto" >
                    ...
                    onselectedindexchanged="gvwQues_SelectedIndexChanged" BackColor="#E2E2E2" 
                        ...
                        <Columns>
                            <asp:CommandField ShowSelectButton="True" SelectText="Edit" ItemStyle-ForeColor="#990000" >
 ...
 <asp:CommandField SelectText="Edit" ShowSelectButton="True" />
                    ...
                    <asp:LinqDataSource ID="lnqwordmemQn" runat="server" ContextTypeName="CJDataClassesDataContext" TableName="MemmoryTestTextQuesCollections">
                    </asp:LinqDataSource>
                ...
                <asp:Panel ID="Panel3" runat="server" ScrollBars="Auto" Visible="False" 
                    ...
                    <asp:GridView ID="gvwImageTypeMemQuestions" runat="server" 
                        AutoGenerateColumns="False" 
                        onselectedindexchanged="gvwImageTypeMemQuestions_SelectedIndexChanged" AllowPaging="True" DataKeyNames="QuestionID" DataSourceID="linqImageTypeMemoryQn" EnableModelValidation="True">
                        <Columns>
                                                       <asp:CommandField SelectText="Edit" ShowSelectButton="True" />
                            <asp:BoundField DataField="QuestionCode" HeaderText="QuestionCode" 
                                SortExpression="QuestionCode" />
                    ...
                    <asp:LinqDataSource ID="linqImageTypeMemoryQn" runat="server" ContextTypeName="CJDataClassesDataContext" TableName="MemmoryTestImageQuesCollections">
                    </asp:LinqDataSource>
