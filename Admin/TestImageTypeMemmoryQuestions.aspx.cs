...
public partial class Admin_TestImageTypeMemmoryQuestions : System.Web.UI.Page
{
    ...
    private void GoToNextPage()
    {
        ...
        Session["SubCtrl"] = "TestAudioQuestions.aspx";
        Response.Redirect("TestAudioQuestions.aspx");
    }
                ...
                if (Session["displaystatus_img"].ToString() == "True")
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = slno - 1; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            string Answer = "";
                            Session["CurrentControlCtrl"] = "TestImageTypeMemmoryQuestions.aspx";// bip 08012010
                            Session["ValueExists"] = "True";
                            Timer1.Enabled = true;
                            UpdateTimer.Enabled = false;// bip 15052010
    ...
    private DataSet GetQuestionList(int testsectionid)
    {
        ...
        {
            Session["questionColl_memImages"] = null; dsQuestionList = null;
