<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CJAdminMaster.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="AddInstructionByVariable.aspx.cs" Inherits="Admin_AddInstructionByVariable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:400px;">
        ...
        <tr>
            <td colspan="2"><h3>
                Variablewise Instructions</h3></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnDeleteImage1" runat="server" onclick="btnDeleteImage1_Click"  Text="Button" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnDeleteImage2" runat="server" Text="Delete" onclick="btnDeleteImage2_Click"  />
