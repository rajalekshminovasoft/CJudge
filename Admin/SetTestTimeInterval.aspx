<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/CJAdminMaster.master" AutoEventWireup="true" CodeFile="SetTestTimeInterval.aspx.cs" Inherits="Admin_SetTestTimeInterval" %>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinqDataSource ID="LinqOrganization" runat="server" ContextTypeName="CJDataClassesDataContext" Select="new (OrganizationID, Name, Status)" TableName="Organizations" Where="AdminAccess == @AdminAccess &amp;&amp; Status == @Status">
                                    <WhereParameters>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:LinqDataSource ID="LinqTestSection" runat="server" ContextTypeName="CJDataClassesDataContext" Select="new (TestSectionId, TestId, SectionName)" TableName="TestSectionsLists" Where="AdminAccess == @AdminAccess &amp;&amp; Status == @Status">
                                    <WhereParameters>
                                        <asp:Parameter DefaultValue="1" Name="AdminAccess" Type="Int32" />
                                        <asp:Parameter DefaultValue="1" Name="Status" Type="Int32" />
                                    </WhereParameters>
                        ...
                        <tr>
                            <td colspan="2" style="padding: 10px">
                                <asp:GridView ID="gvwTimeDetails" runat="server" AutoGenerateColumns="False"  
                                    onselectedindexchanged="gvwTimeDetails_SelectedIndexChanged" ForeColor="Maroon"  >
                                    <Columns>
