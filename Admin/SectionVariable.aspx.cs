...
public partial class Admin_SectionVariable : System.Web.UI.Page
{
        ...
        try
        {
            ...
            else
            {
                if (CheckSectionNameDuplication(txtSectionName.Text.Trim()) == false)
                {
                    ...
                    cjDataclass.AddSectionDetail(sectionid, txtSectionName.Text.Trim(), parentid, status, userid, 1, OrganizationID, sectionCategoryId);
                    if (sectionid > 0)
                        cjDataclass.UpdateSectionNameForAll(txtSectionName.Text, ddlSectionName.SelectedItem.Text);
    ...
    protected void btnSubmitSecondLevelVar_Click(object sender, EventArgs e)
    {
        ...
        if (txtSectionName2.Text == "")
            ...
            if (CheckNameDuplication(txtSectionName2.Text.Trim()) == false)
            {
                ...
                cjDataclass.AddSectionDetail(sectionid, txtSectionName2.Text, parentid, status, userid, adminaccess, OrganizationID, 0);
                if (sectionid > 0)
                    cjDataclass.UpdateSectionNameSub2ForAll(ddlSectionName.SelectedItem.Text, ddlFirstLevelVarList.SelectedItem.Text, txtSectionName2.Text, ddlSecondLevelVarList.SelectedItem.Text);
    ...
    protected void btnAddFirstLevelVar_Click(object sender, EventArgs e)
    {
        ...
        if (txtParentName.Text == "")
            ...
            if (CheckFistLevalNameDuplication(txtParentName.Text.Trim()) == false)
            {
                ...
                int adminaccess = 1;
                if (specialadmin == true) adminaccess = 0;
                cjDataclass.AddSectionDetail(sectionid, txtParentName.Text, parentid, status, userid, adminaccess, OrganizationID, 0);
                if (sectionid > 0)
                    cjDataclass.UpdateSectionNameSub1ForAll(ddlSectionName.SelectedItem.Text, txtParentName.Text, ddlFirstLevelVarList.SelectedItem.Text);
    ...
    protected void btnDeleteSecondLevelVar_Click(object sender, EventArgs e)
    {
        ...
        if (ddlSecondLevelVarList.SelectedValue != "0" && ddlSecondLevelVarList.SelectedValue != "00")
        {
            ...
            cjDataclass.DeleteSectionDetail(secid);
            int variableid = int.Parse(ddlSectionName.SelectedValue);
            int firstvariableid = int.Parse(ddlFirstLevelVarList.SelectedValue);
            cjDataclass.DeleteDataRelatedToVariable(variableid, firstvariableid, secid, ddlSectionName.SelectedItem.Text, ddlFirstLevelVarList.SelectedItem.Text, ddlSecondLevelVarList.SelectedItem.Text);
    ...
    protected void btnDeleteSection_Click(object sender, EventArgs e)
    {
        ...
        if (ddlSectionName.SelectedValue != "0" && ddlSectionName.SelectedValue != "00")
        {
            ...
            var firstlevelvariablelist = from firstlevelvardet in cjDataclass.SectionDetails
            ...
            foreach (var firstlevelvarids in firstlevelvariablelist)
            {
                ...
                cjDataclass.DeleteSectionDetailWithParentId(firstlevelid);
                // dataclasses.DeleteSectionDetail(firstlevelid);
            }
            cjDataclass.DeleteSectionDetailWithParentId(secid);
            cjDataclass.DeleteDataRelatedToVariable(secid, 0, 0, ddlSectionName.SelectedItem.Text, "", "");
    ...
    protected void btnDeleteFirstLevelVar_Click(object sender, EventArgs e)
    {
        ...
        if (ddlFirstLevelVarList.SelectedValue != "0" && ddlFirstLevelVarList.SelectedValue != "00")
        {
            ...
            cjDataclass.DeleteSectionDetailWithParentId(secid);
            int variableid = int.Parse(ddlSectionName.SelectedValue);
            cjDataclass.DeleteDataRelatedToVariable(variableid, secid, 0, ddlSectionName.SelectedItem.Text, ddlFirstLevelVarList.SelectedItem.Text, "");
        }
