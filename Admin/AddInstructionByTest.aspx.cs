...
public partial class Admin_AddInstructionByTest : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        if (ddlCategory.SelectedIndex > 0 && ddlTestName.SelectedIndex > 0)
        {
            ...
            cjDataclass.DeleteTestInstructions(int.Parse(ddlCategory.SelectedValue), adminaccess, OrganizationID, testid);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (ddlCategory.SelectedIndex > 0 && ddlTestName.SelectedIndex > 0 && (FreeTextBox1.Text.Trim() != "" || FreeTextBox2.Text.Trim() != ""))
        {
            ...
            cjDataclass.AddTestInstructions(0, FreeTextBox1.Text, category, status, userid, FreeTextBox2.Text, adminaccess, OrganizationID, testid);
