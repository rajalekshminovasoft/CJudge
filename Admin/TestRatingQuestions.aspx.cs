...
using System.Data;
public partial class Admin_TestRatingQuestions : System.Web.UI.Page
{
    ...
    private void FillTestSectionInstructions()
    {
        ...
        var InstructionDetails = from instructiondet in cjDataclass.TestSectionInstructions
    ...
    private DataSet GetQuestionList(int testsectionid)
    {
                        ...
                        if (ratingtypeQuescount > 0)
                        {
                            ...
                            if (dsQuesCount != null)
                                if (dsQuesCount.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    {
                                        cjDataclass.AddTestBaseQuestionList_Temp(int.Parse(dsQuesCount.Tables[0].Rows[i]["QuestionID"].ToString()), dsQuesCount.Tables[0].Rows[i]["Question"].ToString(), dsQuesCount.Tables[0].Rows[i]["Answer"].ToString(),
        ...
        if (dtQuestionList.Rows.Count > 0)
        {
            ...
            cjDataclass.DeleteTestBaseQuestionList_Temp(userid);
        }
    ...
    private void FillQuestion()
    {
                        ...
                        if (ds.Tables.Count > 0)
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                for (int q = 0; q < ds.Tables[0].Rows.Count; q++)
                                {
                                    ...
                                    cjDataclass.AddUserTestQuestions_Temp(userid, testId, testsectionid, 0, 0, questionid, questiontype);
                                }
                            }
                }
            }
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = slno - 1; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                Session["CurrentControlCtrl"] = "TestRatingQuestions.aspx";// bip 08012010
                ...
                switch (j)
                {
                    ...
                    case 1:
                        ...
                        var Ques2 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques2.Count() > 0)
                    ...
                    case 2:
                        ...
                        var Ques3 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques3.Count() > 0)
                    ...
                    case 3:
                        ...
                        var Ques4 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques4.Count() > 0)
                    ...
                    case 4:
                        ...
                        var Ques5 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques5.Count() > 0)
                    ...
                    case 5:
                        ...
                        var Ques6 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques6.Count() > 0)
                    ...
                    case 6:
                        ...
                        var Ques7 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques7.Count() > 0)
                    ...
                    case 7:
                        ...
                        var Ques8 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques8.Count() > 0)
                    ...
                    case 8:
                        ...
                        var Ques9 = from Ques in cjDataclass.EvaluationResults
                                    where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                    Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                    select Ques;
                        if (Ques9.Count() > 0)
                    ...
                    case 9:
                        ...
                        var Ques10 = from Ques in cjDataclass.EvaluationResults
                                     where Ques.UserId == userid && Ques.Question == ds.Tables[0].Rows[i]["Question"].ToString() && Ques.QuestionID == int.Parse(ds.Tables[0].Rows[i]["QuestionID"].ToString()) &&
                                     Ques.TestId == testId && Ques.TestSectionId == testsectionid
                                     select Ques;
                        if (Ques10.Count() > 0)
    ...
    private void SaveAnswer()
    {
        ...
        if (lblQuesID1.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid1, usercode, tcellQues1.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        answer = 0;// "";
        ...
        if (lblQuesID2.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid2, usercode, tcellQues2.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID3.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid3, usercode, tcellQues3.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID4.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid4, usercode, tcellQues4.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID5.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid5, usercode, tcellQues5.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID6.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid6, usercode, tcellQues6.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID7.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid7, usercode, tcellQues7.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        answer = 0;// "";
        ...
        if (lblQuesID8.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid8, usercode, tcellQues8.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID9.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid9, usercode, tcellQues9.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID10.Text.Trim() != "")
        {
            ...
            cjDataclass.QuesAnswers(qusid10, usercode, tcellQues10.InnerHtml, answerResult, userid, testId, testsectionid, quescategory);
        }
    }
    ...
    private void SetCurrentPageCount()
    {
        ...
        cjDataclass.AddUserTestPageIndex_Temp(userid, testId, testsectionid, 0, 0, pagecount, questiontype);
    }
    ...
    private void GoToPreviousPage()
    {
        ...
        //Session["pagecountRating"] = null;
        Session["SubCtrl"] = "TestVideoQuestions.aspx";
        Response.Redirect("TestVideoQuestions.aspx");
    }
